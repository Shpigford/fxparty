...
ActiveRecord::Schema.define(version: 2022_01_07_162410) do
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.bigint "token_id"
    t.bigint "wallet_id"
    t.datetime "last_purchase_at", precision: 6
  ...
  create_table "tokens", force: :cascade do |t|
    ...
    t.decimal "floor_royalties", default: "0.0"
    t.decimal "potential_royalties", default: "0.0"
  end
  ...
  create_table "wallets", force: :cascade do |t|
    ...
    t.decimal "stat_floor_royalties", default: "0.0"
    t.decimal "stat_potential_royalties", default: "0.0"
